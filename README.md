...
- **Epsilon formula**: `self.epsilon = 80 - self.n_games`
- This approach starts with a high exploration rate and gradually reduces it linearly as the number of games increases.
...
- This approach reduces exploration more gradually compared to strict decay.
...
- **Description**:  
  This strategy combines an **exponential epsilon decay** with the **modified reward system**. The reward system is defined as follows:
